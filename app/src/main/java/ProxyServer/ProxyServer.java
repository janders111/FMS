...
public class ProxyServer {
    ...
    public static void setServerHost(String serverHost) {
        ProxyServer.serverHost = serverHost;
    }

    public static void setServerPort(String serverPort) {
        ProxyServer.serverPort = serverPort;
    }

    public static void setAuthToken(String authToken) { ProxyServer.authToken = authToken;  }
    ...
    public static LoginResponse login(LoginRequest req) {
        try {
            ...
            if (http.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                System.out.println("Recieved a login response.");
                // Get the input stream containing the HTTP response body
                InputStream respBody = http.getInputStream();
                // Extract JSON data from the HTTP response body
                String respData = readString(respBody);
                Gson gson = new Gson();
                LoginResponse respObj = gson.fromJson(respData, LoginResponse.class);
    ...
    public static RegisterResponse register(User req) {
        try {
            ...
            if (http.getResponseCode() == HttpURLConnection.HTTP_OK) {
                // The HTTP response status code indicates success,
                // so print a success message
                System.out.println("Recieved a register response.");
                // Get the input stream containing the HTTP response body
                InputStream respBody = http.getInputStream();
                // Extract JSON data from the HTTP response body
                String respData = readString(respBody);
                Gson gsonRes = new Gson();
                RegisterResponse respObj = gsonRes.fromJson(respData, RegisterResponse.class);
                // Display the JSON data returned from the server
                return respObj;
            }
            else {
    ...
    public static Person getPersonFromID(PersonRequest req) {
        ...
        try {
            ...
            if (http.getResponseCode() == HttpURLConnection.HTTP_OK) {
                // The HTTP response status code indicates success,
                // so print a success message
                System.out.println("Received a getPersonFromID response.");
                // Get the input stream containing the HTTP response body
                InputStream respBody = http.getInputStream();
                // Extract JSON data from the HTTP response body
                String respData = readString(respBody);
                Gson gsonRes = new Gson();
                Person respObj = gsonRes.fromJson(respData, Person.class);
                // Display the JSON data returned from the server
                return respObj;
            }
            else {
    ...
    /**
     *  Gets ALL family members of the current user. The current user is
     determined from the provided auth token.
     * @param
     * @return
     */
    public static PersonAllFamilyResponse getUsersPeople() {
        try {
            ...
            if (http.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                String respData = readString(respBody);
                Gson gsonRes = new Gson();
                PersonAllFamilyResponse respObj = gsonRes.fromJson(respData, PersonAllFamilyResponse.class);
                // Display the JSON data returned from the server
                return respObj;
            }
            else {
     ...
     * @return
     */
    public static PersonAllEventsResponse getUsersEvents() {
        try {
            ...
            if (http.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                String respData = readString(respBody);
                Gson gsonRes = new Gson();
                PersonAllEventsResponse respObj = gsonRes.fromJson(respData, PersonAllEventsResponse.class);
                // Display the JSON data returned from the server
                return respObj;
            }
            else {
